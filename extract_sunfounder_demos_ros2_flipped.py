#!/usr/bin/env python3
"""
CORRECT DIMENSIONS + FLIPPED Y

Combines:
1. Correct leg dimensions from ROS2 (LEG=42mm, FOOT=76mm)
2. Y-coordinate flip for MuJoCo's rotated base frame
"""
...
class SunfounderExtractorROS2Flipped:
    """Extractor with CORRECT dimensions + FLIPPED Y."""
    ...
    def coord2angle(cls, y, z):
        ...
        # FLIP Y for MuJoCo's rotated base
        y = -y
...
def collect_demonstrations(n_cycles=10, standing_height=80, use_camera=False):
    ...
    print("\n" + "="*70)
    print(" ROS2 DIMENSIONS + FLIPPED Y")
    print("="*70)
    print(f"Cycles: {n_cycles}")
    print("="*70 + "\n")

    extractor = SunfounderExtractorROS2Flipped(standing_height=standing_height)
...
def main():
    ...
    parser.add_argument("--output-file", type=str, default="demonstrations/sunfounder_ros2_flipped.pkl")
